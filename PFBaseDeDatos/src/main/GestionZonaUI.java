			...
			if (!Input.ComprobarStringRegex(opcion, "^[1-3]$")) {
				...
				case 1:
					...
					if(serviceZon.registrarZona(zonaAdd)) {
						System.out.println("Zona " + zonaAdd.getNombre() + " añadido correctamente.");
					}
					break;
				case 2:
					System.out.println();
